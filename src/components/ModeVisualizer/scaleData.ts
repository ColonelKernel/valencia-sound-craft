...
export const MODE_INTERVALS: Record<string, number[]> = {
  ...
  'Bebop Harmonic Minor':   [0,2,3,5,7,8,11,10],
  // Pentatonic & Blues
...
export const MODE_INTERVAL_NAMES: Record<string, string[]> = {
  ...
  'Bebop Harmonic Minor':   ['1','2','b3','4','5','b6','7','b7'],
...
export const MODE_CHORDS: Record<string, string[]> = {
  ...
  // Harmonic Major modes
  'Harmonic Major':         ['Imaj7','IIm7b5','IIIm7','IVm(maj7)','V7','bVImaj7#5','VIIdim7'],
  'Dorian b5':              ['Im7b5','IIm7','bIIIm(maj7)','IV7','bVmaj7#5','VIdim7','bVIImaj7'],
  'Phrygian b4':            ['Im7','bIIm(maj7)','bIII7','bIVmaj7#5','Vdim7','bVImaj7','bVIIm7b5'],
  'Lydian b3':              ['Im(maj7)','II7','bIIImaj7#5','#IVdim7','Vmaj7','VIm7b5','VIIm7'],
  'Mixolydian b2':          ['I7','bIImaj7#5','bIIIdim7','IVmaj7','Vm7b5','VIm7','bVIIm(maj7)'],
  'Lydian Augmented #2':    ['Imaj7#5','#IIdim7','IIImaj7','#IVm7b5','#Vm7','VIm(maj7)','VII7'],
  'Locrian bb7':            ['Idim7','bIImaj7','bIIIm7b5','IVm7','bVm(maj7)','bVI7','bVImaj7#5'],
  // Bebop scales
  'Bebop Dominant':         ['I7','IIm7','IIIm7b5','IVmaj7','V7','VIm7','VIIdim7','Imaj7'],
  'Bebop Major':            ['Imaj7','IIm7','IIIm7','IVmaj7','V7','bVIdim7','VIm7','VIIm7b5'],
  'Bebop Minor':            ['Im7','IIm7','bIIImaj7','IIIm7b5','IVmaj7','V7','VIm7','bVII7'],
  'Bebop Dorian':           ['Im7','IIm7','bIIImaj7','IIIm7b5','IVmaj7','V7','VIm7','bVII7'],
  'Bebop Harmonic Minor':   ['Im(maj7)','IIm7b5','bIIImaj7#5','IVm7','V7','bVImaj7','VIIdim7','bVII7'],
